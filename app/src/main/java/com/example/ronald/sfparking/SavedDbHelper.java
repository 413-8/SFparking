...
public class SavedDbHelper extends SQLiteOpenHelper {
    ...
    private static SavedDbHelper instanceDB;
    //constructor
     ...
     */
    public static synchronized SavedDbHelper getInstance(Context context)
    {
        if(instanceDB==null)
            instanceDB=new SavedDbHelper(context);

        return instanceDB;
    }

    private SavedDbHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVer, int newVer){
        Log.d(SavedDbHelper.class.getName(), "Upgrading database from version " + oldVer + " to " +
